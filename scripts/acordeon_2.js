//функция запуска аккордеона №2
$(function() {
    $('.accordion-group').simpleAccordion({
        multiple: true // возможность открытия одной вкладки или всех
    });
});



/*настройки аккордеона №2 (https://atuin.ru/blog/teksty-i-ssylki/)
...
$('.accordion-group').simpleAccordion({
    ...
    cbClose: true, // callback-функция при закрытии вкладки - function (e, $this) {},
